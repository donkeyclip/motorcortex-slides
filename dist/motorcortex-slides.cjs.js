...
var uncurryThis$k = NATIVE_BIND$2 && bind$2.bind(call$8, call$8);
...
var Array$2 = global$c.Array; // a part of `ArraySpeciesCreate` abstract operation
...
var arraySpeciesConstructor$1 = function (originalArray) {
  ...
  if (isArray$2(originalArray)) {
    ...
    if (isConstructor$1(C) && (C === Array$2 || isArray$2(C.prototype))) C = undefined;else if (isObject$3(C)) {
      C = C[SPECIES$3];
...
var Intro = /*#__PURE__*/function (_MotorCortex$HTMLClip) {
  ...
  _createClass$1(Intro, [{
    ...
    value: function buildTree() {
      var titleanime = new MotorCortex.CSSEffect({
        animatedAttrs: {
          width: "100%"
        },
        initialValues: {
      ...
      var bg = new MotorCortex.CSSEffect({
        animatedAttrs: {
      ...
      var subtextRight = new MotorCortex.CSSEffect({
        animatedAttrs: {
          right: "0%"
        },
        initialValues: {
      ...
      var subholderRight = new MotorCortex.CSSEffect({
        animatedAttrs: {
          right: "0%"
        },
        initialValues: {
      ...
      var datespan = new MotorCortex.CSSEffect({
        animatedAttrs: {
          transform: {
            translateX: "0%"
          }
      ...
      var dateHolderWidth = new MotorCortex.CSSEffect({
        animatedAttrs: {
          width: "45%"
        },
        initialValues: {
      ...
      var scaleFirstSlide = new MotorCortex.CSSEffect({
        animatedAttrs: {
          transform: {
            scale: 0.5
          }
      ...
      var description = new MotorCortex.CSSEffect({
        animatedAttrs: {
          transform: {
            translateY: "0%"
          }
      ...
      var descriptiontext = new MotorCortex.CSSEffect({
        animatedAttrs: {
          transform: {
            translateY: "0%"
          }
      ...
      var bgQut = new MotorCortex.CSSEffect({
        animatedAttrs: {
          transform: {
            translateX: "100%"
          }
...
var Transition = /*#__PURE__*/function (_MotorCortex$HTMLClip) {
  ...
  _createClass$1(Transition, [{
    ...
    key: "buildTree",
    value: function buildTree() {
      var transitionText = new MotorCortex.CSSEffect({
        animatedAttrs: {
          left: "-100%"
        },
        initialValues: {
      ...
      var transitionContainer = new MotorCortex.CSSEffect({
        animatedAttrs: {
          left: "100%"
        },
        initialValues: {
  ...
  _createClass$1(SlideDateOne, [{
    ...
    value: function buildTree() {
      ...
      for (var _i = 0; _i < array.length; _i++) {
        ...
        word.addIncident(textAnimation, (2000 + 100 * (_i + 1)) * 2);
      }

      var bgMove = new MotorCortex.CSSEffect({
        animatedAttrs: {
          left: "0%"
        },
        initialValues: {
      ...
      var secondSlideTitleOne = new MotorCortex.CSSEffect({
        animatedAttrs: {
          left: "0%"
        },
        initialValues: {
      ...
      var secondSlideTitleTwo = new MotorCortex.CSSEffect({
        animatedAttrs: {
          left: "0%"
        },
        initialValues: {
      ...
      var wordBg = new MotorCortex.CSSEffect({
        animatedAttrs: {
          left: "0%"
        },
        initialValues: {
      ...
      var shortDescription = new MotorCortex.CSSEffect({
        animatedAttrs: {
          left: "0%"
        },
        initialValues: {
      ...
      var bgscaledownMove = new MotorCortex.CSSEffect({
        animatedAttrs: {
          left: "-25%"
        },
        initialValues: {
      ...
      var bgsecondscaledownMove = new MotorCortex.CSSEffect({
        animatedAttrs: {
          left: "25%"
        },
        initialValues: {
      ...
      var secondBgDate = new MotorCortex.CSSEffect({
        animatedAttrs: {
          left: "5%"
        },
        initialValues: {
      ...
      var moveSecond = new MotorCortex.CSSEffect({
        animatedAttrs: {
          left: "-76%"
        },
        initialValues: {},
      ...
      var moveSecondS = new MotorCortex.CSSEffect({
        animatedAttrs: {
          left: "-76%"
        },
        initialValues: {},
...
var Scrolslide = /*#__PURE__*/function (_MotorCortex$HTMLClip) {
  ...
  _createClass$1(Scrolslide, [{
    ...
    key: "buildTree",
    value: function buildTree() {
      var moveThird = new MotorCortex.CSSEffect({
        animatedAttrs: {
          left: "0%",
          top: "-200%"
        },
      ...
      var thirdScaleUp = new MotorCortex.CSSEffect({
        animatedAttrs: {
          transform: {
            scale: 1
          }
      ...
      var moveThirdIner = new MotorCortex.CSSEffect({
        animatedAttrs: {
          marginTop: "0%",
          marginBottom: "0%"
        },
      ...
      var movePresenter = new MotorCortex.CSSEffect({
        animatedAttrs: {
          transform: {
            translateY: "0%"
          }
...
var LtRslide = /*#__PURE__*/function (_MotorCortex$HTMLClip) {
  ...
  _createClass$1(LtRslide, [{
    ...
    key: "buildTree",
    value: function buildTree() {
      var personConMove = new MotorCortex.CSSEffect({
        animatedAttrs: {
          left: "50%"
        },
        initialValues: {
      ...
      var quarterLeft = new MotorCortex.CSSEffect({
        animatedAttrs: {
          left: "-20%"
        },
        initialValues: {
...
var SlideDateTwo = /*#__PURE__*/function (_MotorCortex$HTMLClip) {
  ...
  _createClass$1(SlideDateTwo, [{
    ...
    value: function buildTree() {
      ...
      var secondSlide = new MotorCortex.CSSEffect({
        animatedAttrs: {
          left: "0%"
        },
        initialValues: {
      ...
      var bigTitle = new MotorCortex.CSSEffect({
        animatedAttrs: {
          left: "-1500px"
        },
        initialValues: {
      ...
      var movePresenterSlide = new MotorCortex.CSSEffect({
        animatedAttrs: {
          top: "0%"
        },
        initialValues: {
      ...
      var movePresenterSlideLeft = new MotorCortex.CSSEffect({
        animatedAttrs: {
          top: "0%"
        },
        initialValues: {
      ...
      var moveBig = new MotorCortex.CSSEffect({
        animatedAttrs: {
          left: "0%"
        },
        initialValues: {
      ...
      var moveBigOut = new MotorCortex.CSSEffect({
        animatedAttrs: {
          top: "-100%"
        },
        initialValues: {
...
var BtTslideDate = /*#__PURE__*/function (_MotorCortex$HTMLClip) {
  ...
  _createClass$1(BtTslideDate, [{
    ...
    value: function buildTree() {
      ...
      var bgscaledownMoveOut = new MotorCortex.CSSEffect({
        animatedAttrs: {
          left: "100%"
        },
        initialValues: {
      ...
      var bgsecondscaledownMoveOut = new MotorCortex.CSSEffect({
        animatedAttrs: {
          left: "0%"
        },
        initialValues: {
      ...
      var bgMoveOut = new MotorCortex.CSSEffect({
        animatedAttrs: {
          left: "100%"
        },
        initialValues: {
...
var SlideDateOneVid = /*#__PURE__*/function (_MotorCortex$HTMLClip) {
  ...
  _createClass$1(SlideDateOneVid, [{
    ...
    value: function buildTree() {
      ...
      var delay = (this.attrs.vidDuration || 6000) - 3000 * 2;
      var array = this.attrs.title[2].split("");
      var html3;
      var containerParams = {
        width: "100%",
